...
INSERT INTO Orders (OrderID, UserID, InstrumentID, Type, Status, CreatedAt, UpdatedAt) VALUES (111, 1, 1, 'Buy', 'Open', SYSDATE - 7, SYSDATE - 7);

-- Inserting second order

INSERT INTO Orders (OrderID, UserID, InstrumentID, Type, Status, CreatedAt, UpdatedAt) VALUES (102, 1, 2, 'Sell', 'Closed', SYSDATE - 5, SYSDATE - 4);

-- Inserting third order (most recent)

INSERT INTO Orders (OrderID, UserID, InstrumentID, Type, Status, CreatedAt, UpdatedAt) VALUES (103, 1, 3, 'Buy', 'Executed', SYSDATE - 1, SYSDATE);

-- Inserting transactions to orders

-- Inserting a transaction for the first order

INSERT INTO Transactions (TransactionID, OrderID, Timestamp) VALUES (201, 101, SYSDATE - 7); -- Assuming TransactionID starts at 201

-- Inserting a transaction for the second order

INSERT INTO Transactions (TransactionID, OrderID, Timestamp) VALUES (202, 102, SYSDATE - 5);

-- Inserting a transaction for the third (most recent) order]

INSERT INTO Transactions (TransactionID, OrderID, Timestamp) VALUES (203, 103, SYSDATE - 1);
